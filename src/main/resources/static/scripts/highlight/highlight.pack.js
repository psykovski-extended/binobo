...
hljs.registerLanguage("less", (() => {
    ...
    return a => {
        ...
        const f = g.concat({begin: /\{/, end: /\}/, contains: c}), h = {
...
hljs.registerLanguage("css", (() => {
    ...
    return n => {
        ...
        }))(n), l = [n.APOS_STRING_MODE, n.QUOTE_STRING_MODE];
        return {
            name: "CSS",
...
hljs.registerLanguage("swift", (() => {
    ...
    const i = e => a(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/), s = ["Protocol", "Type"].map(i),
...
hljs.registerLanguage("cpp", (() => {
    ...
    return n => {
        ...
        var _;
        const g = [p, l, s, r, n.C_BLOCK_COMMENT_MODE, o, c], b = {
            variants: [{begin: /=/, end: /;/}, {begin: /\(/, end: /\)/}, {
